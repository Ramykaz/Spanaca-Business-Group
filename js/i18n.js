...
const SERVICE_LISTS = {
  en: {
    ...
    service3: [
      "Ethiopian specialty products into Turkey (coffee, leather, textiles, spices)",
...
const translations = {
  en: {
    ...
    "service1.body": "Turkey has world-class universities at a fraction of the cost of studying in Europe or North America. But getting there is not simple: scholarship applications, document authentication, visa procedures, TR-YÖS exams, and settling in a new city all require someone who knows the process. We guide students from Ethiopia through every step, from choosing the right university and program to arriving in Turkey ready to start.",
    "service1.imageCaption": "Istanbul University",

    "service2.title": "Health Tourism",
    "service2.tagline": "World-class treatment in Turkey, with someone who speaks your language.",
    "service2.body": "Turkey is one of the world's leading health tourism destinations, with advanced hospitals, experienced doctors, and costs significantly lower than Europe. Ethiopians already travel to Turkey for treatment. What they often lack is a trusted, Amharic-speaking contact who can handle the coordination from start to finish. We connect patients with the right hospitals, handle appointments and logistics, and support families throughout the process.",
    "service2.imageCaption": "Modern healthcare in Turkey",

    "service3.title": "Trade & Import/Export",
    "service3.tagline": "Moving goods between Ethiopia and Turkey, in both directions.",
    ...
    "additional.item2.body": "Visa facilitation, travel coordination, and relocation guidance for individuals and families moving between Ethiopia and Turkey. Ethiopians cannot use the Turkish e-visa and must apply in person, and we help prepare that process properly.",
    ...
    "corridor.fact4": "bilateral trade between Ethiopia and Turkey in 2022",
    ...
    "process.step3.desc": "Documents, applications, appointments, coordination. We manage both sides of the corridor, Turkey and Ethiopia, so you don't have to.",
    ...
    "contact.body": "Whether you are a student planning to study in Turkey, a family seeking medical treatment, a business moving goods, or someone who just needs guidance, reach out. We will tell you honestly what we can do.",
    ...
    "form.successNote": "Thanks. Opening WhatsApp to send your message.",
  ...
  tr: {
    ...
    "form.successNote": "Teşekkürler. Mesajınızı göndermek için WhatsApp açılıyor.",
  ...
  am: {
    ...
    "form.successNote": "እናመሰግናለን። መልእክትዎን ለመላክ ዋትስአፕ በመክፈት ላይ።",
